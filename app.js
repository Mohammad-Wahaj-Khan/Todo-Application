...
function addTodo(){
    ...
    liElement.setAttribute("style" , "background-color: orange;")
    

    var div = document.createElement("div")
    var editBtn = document.createElement("button")
    var editTxt = document.createTextNode("Edit Btn")
    editBtn.appendChild(editTxt)
    editBtn.className = "btn "
    editBtn.setAttribute("style", "background-color: yellow;")
    editBtn.setAttribute("onclick" , "editBtn(this)")

    var removeBtn = document.createElement("button")
    var removeTxt = document.createTextNode("Remove Btn")
